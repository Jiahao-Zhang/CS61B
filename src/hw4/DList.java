...
public class DList {
  ...
  public static void main(String[] args){
	  ...
	  System.out.println(list.toString());
	  list.insertBefore(4, list.head.prev);
	  System.out.println(list.toString());
	  System.out.println("back:"+list.back().item);
	  System.out.println("front:"+list.front().item);
	  System.out.println("head.prev.prev.next:"+list.next(list.head.prev.prev).item);
	  System.out.println("head.prev:"+list.prev(list.head).item);
